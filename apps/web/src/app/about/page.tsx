    ...
    <div className="min-h-screen flex flex-col">
      <div className="flex-grow pt-20 px-6 md:px-20 max-w-7xl mx-auto w-full">
        <section className="py-16 text-center">
          <h1 className="text-5xl font-bold bg-clip-text text-transparent bg-purple-gradient mb-6">
            Our Mission
          </h1>
...
function AboutCard({
  ...
  return (
    <div className="glass-card p-8 border-white/5 hover:border-brandPurple/50 transition-all">
